...
def menu_4():
    while True:
        ...
        if kode == '1':
            ...
            while True:
                print("[1] Tampilkan seluruh data kereta ")
                print("[2] Update data kereta api with RUTE and KODE ")
                print("[3] Update data kereta api with NO ")
                ...
                if kode == '1':
                    ...
                    for i in db_pegawai:
                        if db_pegawai[i]['kode_kereta'] == kode_kereta and db_pegawai[i]['rute_perjalanan'] == rute_perjalanan:
                            updated_data = {
                                ...
                                'nama_kereta': input("Masukan nama kereta baru (kosongkan jika tidak ingin mengubah): ").capitalize(),
                                'jenis_kereta': input("Masukan jenis kereta baru (kosongkan jika tidak ingin mengubah): ").capitalize(),
                    ...
                    nomor_kereta = input("Masukan Nomor kereta yang ingin diupdate: ").upper()

                    for i in db_pegawai:
                        if db_pegawai[i]['no_kereta'] == nomor_kereta:
                            updated_data = {
                                'no_kereta' : input("Masukan no kereta baru (kosongkan jika tidak ingin mengubah): ").upper(),
                                'nama_kereta': input("Masukan nama kereta baru (kosongkan jika tidak ingin mengubah): ").capitalize(),
                                'jenis_kereta': input("Masukan jenis kereta baru (kosongkan jika tidak ingin mengubah): ").capitalize(),
                                'rute_perjalanan' : input("Masukan rute perjalanan (kosongkan jika tidak ingin mengubah)").upper(),
                                'harga': int(input("Masukan harga baru (kosongkan jika tidak ingin mengubah): ")),
                                'waktu_keberangkatan': input("Masukan waktu keberangkatan baru (kosongkan jika tidak ingin mengubah): "),
                                'tanggal_keberangkatan': input("Masukan tanggal keberangkatan baru (kosongkan jika tidak ingin mengubah): ")
                            }
                        ...
                        print(f"Nomor kereta {nomor_kereta}  tidak tersedia ")
...
def menu_5():
    while True:
        ...
        if kode == '4':
            ...
            while True :
                print("[1] Tampilkan Pemesanan Tiket Kereta Api ")
                print("[2] Pelunasan Data Pemesanan Tiket Kereta Api ")
                print("[3] Back to Menu ")
                    ...
                    for key, value in db_temp_pelanggan.items():
                        if value['no'] == pelunasan_no:
                            ...
                            if konfirmasi.lower() == 'y':
                                total_pembayaran = abs(int(value['harga']))
                                pembayaran = 0
                                while pembayaran < total_pembayaran:
                                    ...
                                    tambahan = abs(int(input("Silahkan masukan nominal pembayaran: ")))
                                    pembayaran += tambahan
